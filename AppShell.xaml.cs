...
public partial class AppShell : Shell
{
    public AppShell()
    {
        ...
        Routing.RegisterRoute(nameof(FavoritesPlaylistPage), typeof(FavoritesPlaylistPage)); Routing.RegisterRoute(nameof(AccountCreationPage),  typeof(AccountCreationPage));
